...
@Service
@Transactional
public class UserSecurityService implements SecurityAccountService {
    ...
    public String validatePasswordResetToken(long id, String token) {
        ...
        if ((passToken == null) || (passToken.getAccount()
                .getId() != id)) {
            return "invalidToken";
        }
        ...
        final Authentication auth = new UsernamePasswordAuthenticationToken(account, null, Arrays.asList(new SimpleGrantedAuthority("CHANGE_PASSWORD_PRIVILEGE")));
